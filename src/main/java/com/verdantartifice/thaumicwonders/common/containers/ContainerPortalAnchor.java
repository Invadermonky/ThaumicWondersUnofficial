...
import com.verdantartifice.thaumicwonders.common.containers.slots.SlotPortalLinker;
...
public class ContainerPortalAnchor extends Container {
    private InventoryPlayer inventoryPlayer;
    private TilePortalAnchor tileEntity;

    public ContainerPortalAnchor(InventoryPlayer playerInventory, TilePortalAnchor anchorTile) {
        this.inventoryPlayer = playerInventory;
        this.tileEntity = anchorTile;

        this.addSlotToContainer(new SlotPortalLinker(this.tileEntity, 0, 80, 62));
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 9; j++) {
