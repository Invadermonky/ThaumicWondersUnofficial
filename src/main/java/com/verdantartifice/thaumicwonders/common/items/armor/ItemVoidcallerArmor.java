...
import com.verdantartifice.thaumicwonders.client.renderers.models.gear.ModelVoidcallerArmor;
...
public class ItemVoidcallerArmor extends ItemArmor implements ISpecialArmor, IWarpingGear, IVisDiscountGear, IGoggles {
    public static ItemArmor.ArmorMaterial MATERIAL = EnumHelper.addArmorMaterial("VOIDCALLER", "VOIDCALLER", 50, new int[]{4, 7, 9, 4}, 15, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 2.0F);
    ModelBiped model1 = null;
    ModelBiped model2 = null;

    public ItemVoidcallerArmor(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
    ...
    public ArmorProperties getProperties(EntityLivingBase player, ItemStack armor, DamageSource source, double damage, int slot) {
        ...
        for (EntityEquipmentSlot equipmentSlot : slots) {
            ...
            if (!piece.isEmpty() && piece.getItem() instanceof ItemVoidcallerArmor) {
                set++;
            }
        }
        if (set >= 2) {
    ...
    public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        if (stack.getItem() == ItemsTW.VOIDCALLER_HELM) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
        return ThaumicWonders.MODID + ":textures/entities/armor/voidcaller_armor.png";
    }
    ...
    public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack itemStack, EntityEquipmentSlot armorSlot, ModelBiped _default) {
        if (this.model1 == null) {
            this.model1 = new ModelVoidcallerArmor(0.5f);
        }
        if (this.model2 == null) {
            this.model2 = new ModelVoidcallerArmor(1.0F);
        }
